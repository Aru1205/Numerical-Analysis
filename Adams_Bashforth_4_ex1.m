clc;
clear;
fprintf("\n Adams-Bashforth method of order 4 to solve y'=te^(3t)-2y, y(t0)=y0. :\n");
...
% Adams-Bashforth algorithm of order 4
for i=4:N
...
% Error computation
 ...
 title('Adams-Bashforth method of order four', 11)
 xlabel('t-->')
 ylabel('y(t)-->')
 % xlim([-0.2 1.2])
 % ylim([-.3 4])
legend('Exact Soln.','Data points on exact soln.','AB Approx. soln.', 'Location', 'northwest')
grid on